...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 16, 2024 at 05:38 AM
...
--
-- Table structure for table `tbl_housewife`
--

CREATE TABLE `tbl_housewife` (
  `housewife_id` int(11) NOT NULL,
  `housewife_name` varchar(100) NOT NULL,
  `housewife_contact` varchar(100) NOT NULL,
  `housewife_address` varchar(100) NOT NULL,
  `housewife_photo` varchar(100) NOT NULL,
  `housewife_proof` varchar(100) NOT NULL,
  `housewife_status` int(11) NOT NULL DEFAULT 0,
  `housewife_doj` date NOT NULL DEFAULT current_timestamp(),
  `place_id` int(11) NOT NULL,
  `housewife_email` varchar(100) NOT NULL,
  `housewife_password` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indexes for table `tbl_housewife`
--
ALTER TABLE `tbl_housewife`
  ADD PRIMARY KEY (`housewife_id`);
...
--
-- AUTO_INCREMENT for table `tbl_housewife`
--
ALTER TABLE `tbl_housewife`
  MODIFY `housewife_id` int(11) NOT NULL AUTO_INCREMENT;
