...
<html lang="en" >
    ...
    <%        if (request.getParameter("aid") != null) {
            ...
            String upQry = "update tbl_housewife set housewife_status='1' where housewife_id='" + request.getParameter("aid") + "'";
        ...
        if (request.getParameter("rid") != null) {
            ...
            String upQry = "update tbl_housewife set housewife_status='2' where housewife_id='" + request.getParameter("rid") + "'";
            if (con.executeCommand(upQry)) {
    ...
    %>
    <body>
        <h1 align="center" id="heading">House Wife Data</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_housewife c inner join tbl_place p on p.place_id=c.place_id inner join tbl_district d on d.district_id=p.district_id";
                ...
                <tr>
                    <td><%=i%></td>
                    <td><%=rs.getString("housewife_name")%></td>
                    <td><%=rs.getString("district_name")%></td>
                    <td><%=rs.getString("place_name")%></td>
                    <td><%=rs.getString("housewife_contact")%></td>
                    <td><%=rs.getString("housewife_email")%></td>
                    <td align="center">
                        <%
                            if (rs.getString("housewife_status").equals("0")) {
                        %>
                        <a href="NewHouseWife.jsp?aid=<%=rs.getString("housewife_id")%>"><img src="../Assets/Template/admin/check.png" width="25" height="25"></a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="NewHouseWife.jsp?rid=<%=rs.getString("housewife_id")%>"><img src="../Assets/Template/admin/remove.png"  width="25" height="25"></a>
                            <%
                            } else if (rs.getString("housewife_status").equals("1")) {
                            %>
                        <a href="NewHouseWife.jsp?rid=<%=rs.getString("housewife_id")%>"><img src="../Assets/Template/admin/remove.png"  width="25" height="25"></a>
                            <%
                            } else if (rs.getString("housewife_status").equals("2")) {
                            %>
                        <a href="NewHouseWife.jsp?aid=<%=rs.getString("housewife_id")%>"><img src="../Assets/Template/admin/check.png" width="25" height="25"></a>
                            <%
                                }
