...
<html lang="en" >
    ...
    <body>
        <h1 align="center" id="heading">Report Data</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    
                    int i = 0;
                    String selQry = "select * from tbl_cart c inner join tbl_booking b on b.booking_id=c.booking_id inner join tbl_product p on p.product_id=c.product_id INNER join tbl_user u on u.user_id=b.user_id inner join tbl_housewife s on s.housewife_id=p.housewife_id where booking_status=2";
                    ResultSet rs = con.selectCommand(selQry);
                    double total=0;
                    while (rs.next()) {
                        i++;
                        int amount =Integer.parseInt(rs.getString("product_rate"))*Integer.parseInt(rs.getString("cart_qty"));
                        double profit = amount*.10;
                         total =total+profit;
                %>
                <tr>
                    <td><%=i%></td>
