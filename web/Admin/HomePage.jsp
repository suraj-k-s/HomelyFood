                                                ...
                                                <div class="single_quick_activity d-flex">
                                                    ...
                                                    <div class="count_content">
                                                        <h3><span class="counter">
                                                                <%                
                                                                    String csel = "select count(*) as c from tbl_housewife where housewife_status='1'";
                        ...
                        <div class="col-xl-12">
                            <div class="white_box card_height_100">
                                ...
                                <div class="staf_list_wrapper sraf_active owl-carousel">
                                    ...
                                    <%
                                        String cQry = "select * from tbl_housewife c inner join tbl_place p on p.place_id=c.place_id ORDER BY RAND()";
                                    ...
                                    <div class="single_staf">
                                        <div class="staf_thumb">
                                            <img src="../Assets/Files/<%=crs.getString("housewife_photo")%>" alt="">
                                        </div>
                                        <h4><%=crs.getString("housewife_name")%></h4>
