...
<html>
    ...
    <head>
        ...
        <link rel="shortcut icon" href="../Assets/Template/main/images/favicon.png" type="image/x-icon">
                ...
                <nav class="navbar navbar-expand-lg custom_nav-container ">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav  ">   
                            ...
                            <li class="nav-item"><a class="nav-link" href="Bookings.jsp">Booking</a></li>  
                            <li class="nav-item"><a class="nav-link" href="Complaint.jsp">Complaint</a></li>
