    ...
    if (isMultipart) {
        ...
        while (itr.hasNext())//checking if there is any value in the position like rs.next()
        {
            ...
            if (f_item.isFormField()) {
                ...
                value[k] = f_item.getString();//housewife typing value
        ...
        if (value[7].equals(value[6])) {//Strinh str1="insert into tbl_housewife ()";//inserting file
            String InsQry = "INSERT INTO `tbl_housewife`( `housewife_name`, `housewife_contact`, `housewife_email`,`housewife_address`,place_id, `housewife_photo`,`housewife_proof`,`housewife_password`)"
...
<script type="text/javascript">
    ...
    setTimeout(function() {
        window.location.href = '../../HouseWife.jsp'
