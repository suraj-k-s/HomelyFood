    ...
    <body>
        ...
        <%
            if (request.getParameter("btn_submit") != null) {
                ...
                rsd.next();
                if (cp.equals(rsd.getString("housewife_password"))) {
                    if (np.equals(rsd.getString("housewife_password"))) {
        %>
        <script>
        ...
        <%
            ...
            if (np.equals(rp)) {
                String upQry = "update tbl_housewife set housewife_password='" + np + "' where housewife_id='" + session.getAttribute("sid") + "'";
